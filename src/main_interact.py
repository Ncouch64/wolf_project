""" 
This is a script that is updated to most current work, but not really tested due to moving towards different evaluation metrics. This should still work though and give
human operator the chance to assume to role of one of the players.
"""
