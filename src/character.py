...
class Player:
    ...
    model: str = "gpt-3.5-turbo"  # Updated model from gpt-3.5-turbo to gpt-4
...
def get_next_speaker(conversation_history: List[str], player_names=List[str], model="gpt-3.5-turbo"):
